...
export default function Navbar() {
  return (
    ...
    <nav className="font-poppins sticky top-0 z-50 flex justify-between bg-white/10 px-5 py-3 backdrop-blur items-center">
      <div className="w-1/6">
        <p className="cursor-default text-2xl font-bold">Satzz</p>
      </div>
